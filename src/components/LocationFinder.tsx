...
export default function LocationFinder() {
  ...
  return (
    <section id="locations" className="w-full px-4 sm:px-8 lg:px-16 py-20">
      <div className="text-center mb-10">
        <p className="text-accent text-normal3 font-semibold tracking-wider uppercase mb-2">
          Locations
        </p>
        <h2 className="text-h3 sm:text-h2 font-semibold">
      ...
      <div className="max-w-xl mx-auto mb-10 flex gap-3">
        <input
          ...
          className="flex-1 bg-navy-card border border-navy-border rounded-lg px-5 py-3 text-normal2 text-white placeholder-gray-500 outline-none focus:border-accent/50 transition-colors"
        />
        <button className="bg-primary-dark hover:bg-primary text-white font-semibold px-6 py-3 rounded-lg transition-colors text-normal2">
          Search
        </button>
      </div>
        ...
        {filtered.map((location) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-normal3 text-gray-400 mb-3">
                {location.address}
              </p>
